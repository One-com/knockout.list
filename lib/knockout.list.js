...
(function (root, factory) {
    ...
    ko.bindingHandlers.list = {
        init: function (element, valueAccessor, allBindingsAccessor, viewModel, bindingContext) {
            ...
            function calculateDividerPosition(index) {
            ...
            function showIndex(index) {
                ...
                if (index === 0) {
                    // Make sure to show dividers above the first item as possible
                    $element.scrollTop(tileBottom - $element.height());
                }

                if (tileTop <= $element.scrollTop()) {
            ...
            function showDivider(index) {
                if (index in dividerCache) {
                    var top = calculateDividerPosition(index);
