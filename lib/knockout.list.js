    ...
    ko.bindingHandlers.list = {
        init: function (element, valueAccessor, allBindingsAccessor, viewModel, bindingContext) {
            ...
            if (bindingValue.onUpdate) {
                ...
                if (bindingValue.scrollParentSelector) {
                    dataSource.scrollParentSelector = bindingValue.scrollParentSelector;
                }
            ...
            if (bindingValue.scrollParentSelector) {
                $scrollElement = $element.parent(bindingValue.scrollParentSelector);
            }
